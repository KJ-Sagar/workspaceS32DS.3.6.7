...
/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN8 */
#define FLEXCAN_IP_FEATURE_INSTANCE_8_MAX_MB_NUM    (64U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN9 */
#define FLEXCAN_IP_FEATURE_INSTANCE_9_MAX_MB_NUM    (64U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN10 */
#define FLEXCAN_IP_FEATURE_INSTANCE_10_MAX_MB_NUM    (64U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN11 */
#define FLEXCAN_IP_FEATURE_INSTANCE_11_MAX_MB_NUM    (64U)
...
#define FLEXCAN_IP_FEATURE_MAX_MB_NUM_ARRAY { \
                        ...
                        FLEXCAN_IP_FEATURE_INSTANCE_8_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_9_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_10_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_11_MAX_MB_NUM \
}
