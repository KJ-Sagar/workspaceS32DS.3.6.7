...
==================================================================================================*/
#define GMAC_IP_SA_VS_0_PBCFG_VENDOR_ID_C                     43
#define GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION_C      4
#define GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C      9
#define GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define GMAC_IP_SA_VS_0_PBCFG_SW_MAJOR_VERSION_C              7
#define GMAC_IP_SA_VS_0_PBCFG_SW_MINOR_VERSION_C              0
#define GMAC_IP_SA_VS_0_PBCFG_SW_PATCH_VERSION_C              1

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Gmac_Ip_Types.h */
#if (GMAC_IP_SA_VS_0_PBCFG_VENDOR_ID_C != GMAC_IP_TYPES_VENDOR_ID)
    #error "Gmac_Ip_Sa_VS_0_PBcfg.c and Gmac_Ip_Types.h have different vendor ids"
#endif
#if ((GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != GMAC_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C    != GMAC_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION_C != GMAC_IP_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Gmac_Ip_Sa_VS_0_PBcfg.c and Gmac_Ip_Types.h are different"
#endif
#if ((GMAC_IP_SA_VS_0_PBCFG_SW_MAJOR_VERSION_C != GMAC_IP_TYPES_SW_MAJOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_SW_MINOR_VERSION_C != GMAC_IP_TYPES_SW_MINOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_SW_PATCH_VERSION_C != GMAC_IP_TYPES_SW_PATCH_VERSION)    \
    )
    #error "Software Version Numbers of Gmac_Ip_Sa_VS_0_PBcfg.c and Gmac_Ip_Types.h are different"
#endif

/* Checks against Gmac_Ip_Cfg.h */
#if (GMAC_IP_SA_VS_0_PBCFG_VENDOR_ID_C != GMAC_IP_CFG_VENDOR_ID)
    #error "Gmac_Ip_Sa_VS_0_PBcfg.c and Gmac_Ip_Cfg.h have different vendor ids"
#endif
#if ((GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != GMAC_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C    != GMAC_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION_C != GMAC_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Gmac_Ip_Sa_VS_0_PBcfg.c and Gmac_Ip_Cfg.h are different"
#endif
#if ((GMAC_IP_SA_VS_0_PBCFG_SW_MAJOR_VERSION_C != GMAC_IP_CFG_SW_MAJOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_SW_MINOR_VERSION_C != GMAC_IP_CFG_SW_MINOR_VERSION) || \
     (GMAC_IP_SA_VS_0_PBCFG_SW_PATCH_VERSION_C != GMAC_IP_CFG_SW_PATCH_VERSION)    \
    )
    #error "Software Version Numbers of Gmac_Ip_Sa_VS_0_PBcfg.c and Gmac_Ip_Cfg.h are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Checks against Mcal.h */
    #if ((GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION_C != MCAL_AR_RELEASE_MAJOR_VERSION) || \
         (GMAC_IP_SA_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C != MCAL_AR_RELEASE_MINOR_VERSION)    \
        )
        #error "AUTOSAR Version Numbers of Gmac_Ip_Sa_VS_0_PBcfg.c and Mcal.h are different"
    #endif
#endif
...
VAR_ALIGN(extern Gmac_Ip_BufferDescriptorType GMAC_1_RxRing_0_DescBuffer[GMAC_1_MAX_RXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
VAR_ALIGN(extern uint8 GMAC_1_RxRing_0_DataBuffer[(GMAC_1_MAX_RXBUFF_SUPPORTED * GMAC_1_MAX_RXBUFFLEN_SUPPORTED)], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
VAR_ALIGN(extern Gmac_Ip_BufferDescriptorType GMAC_1_TxRing_0_DescBuffer[GMAC_1_MAX_TXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
VAR_ALIGN(extern uint8 GMAC_1_TxRing_0_DataBuffer[(GMAC_1_MAX_TXBUFF_SUPPORTED * GMAC_1_MAX_TXBUFFLEN_SUPPORTED)], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
...
static Gmac_Ip_TxGateControl GMAC_1_aGateControlListPB_VS_0[1U]  =
{
    {
        /*.timeInterval = */0U,
        /*.gateControlFifo = */0U
...
static const uint8 GMAC_1_au8MacAddrPB_VS_0[GMAC_MAC_ADDR_LENGTH] = { 0x02U, 0x00U, 0x00U, 0x00U, 0x00U, 0x01U };
...
static const Gmac_Ip_RxRingConfigType GMAC_1_aRxRingConfigPB_VS_0[1U] =
{
    /* The configuration structure for Rx Ring 0 */
    {
...
static const Gmac_Ip_TxRingConfigType GMAC_1_aTxRingConfigPB_VS_0[1U] =
{
    /* The configuration structure for Tx Ring 0 */
    {
        /*.weight = */0U,
...
static const Gmac_Ip_ConfigType GMAC_1_InitConfigPB_VS_0 =
{
    /*.rxRingCount = */1U,
    /*.txRingCount = */1U,
#if (FEATURE_GMAC_ASP_ALL || FEATURE_GMAC_ASP_ECC)
...
static const Gmac_Ip_TxTimeAwareShaper GMAC_1_pTxTimeShaperPB_VS_0 =
{
    /*.baseTimeSecond = */0U,
    /*.baseTimenanoSecond = */0U,
    /*.cycleTimeSecond = */0U,
    ...
    /*.extendedTime = */0U,
    /*.gateControlListDepth = */0U,
    /*.GateControlList = */&GMAC_1_aGateControlListPB_VS_0[0U]
};
...
const Gmac_CtrlConfigType Gmac_0_ConfigPB_VS_0 =
{
...
const Gmac_CtrlConfigType Gmac_1_ConfigPB_VS_0 =
{
    &GMAC_1_StateStructure,
    &GMAC_1_InitConfigPB_VS_0,
    &GMAC_1_aRxRingConfigPB_VS_0[0U],
    &GMAC_1_aTxRingConfigPB_VS_0[0U],
    &GMAC_1_au8MacAddrPB_VS_0[0U],
    &GMAC_1_pTxTimeShaperPB_VS_0
#if (STD_ON == GMAC_IP_HAS_RX_L3_L4_FILTERS)
    ,NULL_PTR
#endif
#if defined(GMAC_IP_FRAME_PREEMPTION_ENABLE) && (STD_ON == GMAC_IP_FRAME_PREEMPTION_ENABLE)
